...
autocmd FileType vim,tex let b:autoformat_retab=0
autocmd FileType vim,tex let b:autoformat_remove_trailing_spaces=0

Plug 'tpope/vim-surround'

Plug 'tpope/vim-fugitive'

" use ]c and [c to jump to the next/previous change
